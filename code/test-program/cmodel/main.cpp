...
//    void setParameters(motorParametersType motorParameters)
//    {
//       motorParameters = motorParameters;
//    }
//      motorParametersType getParameters()
//      {
...
// MyClass myObj;
// myObj.setParameters(motorParameters);

// std::cout << "motor from initialization R1= " << motorParametersData.R1<< "\n";
// std::cout << "motor from object R1= " << myObj.getParameters().R1 << "\n";
