...
int main()
{
    ...
    float globalCalculationStep = 0.000001; // 0.000001 0.0001
    ...
    if (modeSelection == 0)
    {
        ...
        for (int i = 0; i < MotorModel.odeCalculationSettings->numberOfIterations; i++)
        {
            ...
            CurVelModel2.modelCVVariables->motorElectricalAngularVelocity = CurVelModel2.modelCVVariables->inputMotorMechanicalAngularVelocity[i] * MotorModel.motorParameters->nOfPolePairs;
