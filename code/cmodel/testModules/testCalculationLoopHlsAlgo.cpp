...
// float regulatorFloatData[11];
// bool regulatorBoolData[3];

// regulatorFloatData[0] == saturationInput
// regulatorFloatData[1] == wantedValue
// regulatorFloatData[2] == measuredValue
// regulatorFloatData[3] == saturationOutput
// regulatorFloatData[4] == antiWindUpDif
// regulatorFloatData[5] == eDif
// regulatorFloatData[6] == iSum
// regulatorFloatData[7] == kp
// regulatorFloatData[8] == ki
// regulatorFloatData[9] == saturationOutputMax
// regulatorFloatData[10] == saturationOutputMin

// regulatorBoolData[0] == clampingStatus
// regulatorBoolData[1] == saturationCheckStatus
// regulatorBoolData[2] == signCheckStatus



void regCalculateHls(float *regulatorFloatData, bool *regulatorBoolData)
{
...
int main()
{
   ...
   /*-------------------- VELOCITY REGULATOR ---------------------*/
    ...
    bool iDregulatorBoolData[3];

    iDregulatorFloatData[0] = Regulator.idRegulator->saturationInput;
    iDregulatorFloatData[1] = Regulator.idRegulator->wantedValue;
    iDregulatorFloatData[2] = Regulator.idRegulator->measuredValue;
    iDregulatorFloatData[3] = Regulator.idRegulator->saturationOutput;
    iDregulatorFloatData[4] = Regulator.idRegulator->antiWindUpDif;
    iDregulatorFloatData[5] = Regulator.idRegulator->eDif;
    iDregulatorFloatData[6] = Regulator.idRegulator->iSum;
    iDregulatorFloatData[7] = Regulator.idRegulator->kp;
    iDregulatorFloatData[8] = Regulator.idRegulator->ki;
    iDregulatorFloatData[9] = Regulator.idRegulator->saturationOutputMax;
    iDregulatorFloatData[10] = Regulator.idRegulator->saturationOutputMin;

    iDregulatorBoolData[0] = Regulator.idRegulator->clampingStatus;
    iDregulatorBoolData[1] = Regulator.idRegulator->saturationCheckStatus;
    iDregulatorBoolData[2] = Regulator.idRegulator->signCheckStatus;
    ...
    bool iQregulatorBoolData[3];

    iQregulatorFloatData[0] = Regulator.iqRegulator->saturationInput;
    iQregulatorFloatData[1] = Regulator.iqRegulator->wantedValue;
    iQregulatorFloatData[2] = Regulator.iqRegulator->measuredValue;
    iQregulatorFloatData[3] = Regulator.iqRegulator->saturationOutput;
    iQregulatorFloatData[4] = Regulator.iqRegulator->antiWindUpDif;
    iQregulatorFloatData[5] = Regulator.iqRegulator->eDif;
    iQregulatorFloatData[6] = Regulator.iqRegulator->iSum;
    iQregulatorFloatData[7] = Regulator.iqRegulator->kp;
    iQregulatorFloatData[8] = Regulator.iqRegulator->ki;
    iQregulatorFloatData[9] = Regulator.iqRegulator->saturationOutputMax;
    iQregulatorFloatData[10] = Regulator.iqRegulator->saturationOutputMin;

    iQregulatorBoolData[0] = Regulator.iqRegulator->clampingStatus;
    iQregulatorBoolData[1] = Regulator.iqRegulator->saturationCheckStatus;
    iQregulatorBoolData[2] = Regulator.iqRegulator->signCheckStatus;
    ...
    for(int i = 0; i<1000000;i++)
    {
        ...
        // Regulator.iqRegulator->saturationOutputMax = sqrt((Udcmax * Udcmax) - (iDregulatorFloatData[3] * iDregulatorFloatData[3]));
        iQregulatorFloatData[9] = sqrt((Udcmax * Udcmax) - (iDregulatorFloatData[3] * iDregulatorFloatData[3]));
        ...
        iDregulatorFloatData[1] = Regulator.fluxRegulator->saturationOutput;
        // Regulator.iqRegulator->wantedValue = Regulator.velocityRegulator->saturationOutput;
        iQregulatorFloatData[1] = Regulator.velocityRegulator->saturationOutput;
        /*--------------------------------------------------------------------------------------------------------*/
        ...
        regCalculateHls(iDregulatorFloatData, iDregulatorBoolData);
        // Regulator.regCalculate(Regulator.iqRegulator);
        regCalculateHls(iQregulatorFloatData, iQregulatorBoolData);
        /*---------------------------------------------------------------------------*/
        ...
        if(verboseOutput)
        {
            ...
            std::cout << "id regulator output value: " << iDregulatorFloatData[3] << "\n";


            std::cout << "id regulator wanted value: " << Regulator.idRegulator->wantedValue << "\n";
            std::cout << "iq regulator output value: " << iQregulatorFloatData[3] << "\n";
        }
        /*-------------------------------------------------------------------------------------------------------*/
        ...
        svmCore.coreInternalVariables->u1d = iDregulatorFloatData[3];
        svmCore.coreInternalVariables->u1q = iQregulatorFloatData[3];
        /*-------------------------------------------------------------------------------------------------------*/
       ...
       /****************************************************************************************************************************************************/
        ...
        iDregulatorFloatData[2] = Transformation.parkTransform1(CurVelModel.modelCVVariables->i1alpha, CurVelModel.modelCVVariables->i1beta, CurVelModel.modelCVVariables->transformAngle);
        ...
        iQregulatorFloatData[2] = Transformation.parkTransform2(CurVelModel.modelCVVariables->i1alpha, CurVelModel.modelCVVariables->i1beta, CurVelModel.modelCVVariables->transformAngle);
