...
columns = ["calculationTime", "triangleWavePoint"]
...
df = pd.read_csv("triangleWaveData.csv", names=columns, header=None, skiprows=0, nrows=400000)

# print out part of the csv files as a text to terminal
print("Contents in csv file:", df)

# naming figure window
figure_first = plt.figure("Triangle wave data")

# setting plot title and font
plt.title("Triangle wave data", fontsize=30, fontweight=700)
...
plt.plot(df.calculationTime,df.triangleWavePoint, color=ctuRed)
