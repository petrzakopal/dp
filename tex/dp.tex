...
void signal_callback_handler(int signum)
{
	...
	Pro zjednodušení adresování jsou definovány jednotlivé posuny od základní adresy pomocí \texttt{define} direktiv. Definice direktiv dle dokumentace \cite{axi-quad-spi-ip-product-guide} je zobrazena v \ref{lst:define-direktivy-spi.}
