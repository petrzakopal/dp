...
\section{System on Modules}
	...
	\subsubsection{Paměťové elementy}\label{subsubsec:pametove-elementy}
		...
		\subsubsection{Konverze HDL na konfigurační Bitstream}
			V části \hyperref[subsubsec:forma-tvorby-algoritmu-pro-fpga]{\textit{Forma tvorby algoritmu pro FPGA}} byly představeny dvě hlavní formy tvorby algoritmu pro FPGA. Aby bylo možné algoritmy na FPGA „umístit“, je třeba jejich vytvořenou rezprezentaci dále zpracovat.\par
