...
plt.show()\end{lstlisting}
		...
		\begin{figure}[htbp!]
			\centering
			\includegraphics[width=1\textwidth]{src/png/k26-simulace-graf-mechanicka-rychlost-velikost-mg-toku-rotoru.png}
...
float psi2betaFce(float R2MLmDL2, float R2DL2, float i1alpha, float i1beta, float psi2alpha, float psi2beta, float motorElectricalAngularVelocity)
    {
		...
		\subsubsection{Implementace regulátorů}
			V~kernelu byly implementovány PI regulátory se strukturou naznačenou na obr. \ref{}. Pro omezení wind-up efektu byl použit princip \textit{clamping}.\par
