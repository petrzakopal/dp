			...
			\begin{table}[htbp!]
			  ...
			  \vspace*{0.15cm}
			   \resizebox{\textwidth}{!}
				...
				3 & Shared \gls{abbreviation:uart}/JTAG \gls{abbreviation:usb} port & komunikace \gls{abbreviation:uart} a JTAG debugging\\ \hline
				...
				21 & Programming Mode Jumper & výběr „programovacího vstupu“, \gls{abbreviation:sd} karta, QSPI, JTAG\\ \hline
				22 & Independent JTAG Mode Enable Jumper & JTAG mimo \gls{abbreviation:ps}, viditelné pouze \gls{abbreviation:pl}\\ \hline
