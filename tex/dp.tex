...
\section{System on Modules}\label{sec:system-on-modules}
	...
	\section{Vývojová deska Digilent Zybo}\label{sec:vyvojova-deska-digilent-zybo}
		...
		\fbar
		\section{Vývojová deska Kria KR260}
				...
				\begin{figure}[H]
					\centering
						\includegraphics[width=1\textwidth]{src/jpg/xilinx-kria-foto-2.jpg} 
						\caption{Vývojová deska Xilinx Kria KR260 vrchní pohled s vyznačením komponent.}
						\label{fig:xilinx-kria-foto-2}
				\end{figure}
			...
			\subsection{Platforma Digilent Zybo s ZynQ SoC}

			\subsection{Platforma KR260 se SOM Kria}
