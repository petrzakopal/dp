...
\section{Program pro FPGA a CPU}
	\subsection{Použité nástroje}
		...
		\subsubsection{Programovací prostředí – operační systém Linux}
			...
			V případě využívání představených nástrojů a systému Linux je třeba dbát na správné postupy instalací a v případě problémů využívat dostupné dokumentace. Značným problémem bývá nemožnost zápisu programu do složky, ne
