...
\newglossaryentry{symbol:udc}{
    type=symbolslist, % glossary
    name=$U_\text{dc}$, % jméno v seznamu
    description={napájecí napětí ve stejnosměrném meziobvodu invertoru}, %popis
    symbol = (V),
    sort=U % seředit podle
}
...
\newglossaryentry{symbol:psi2}{
    ...
    description={velikost vektoru magnetického toku rotoru}, %popis
    symbol = (Wb),
    sort=P % seředit podle
}
...
\newglossaryentry{symbol:konstanta-clarkovi-transformace-pri-wk-0}{
    ...
    description={konstanta Clarkovi transformace}, %popis
    symbol = (-),
...
\newglossaryentry{symbol:u1a-fazove-napeti-statoru}{
    type=symbolslist, % glossary
    name=$u_\text{1a}$, % jméno v seznamu
    description={velikost napětí statoru fáze A}, %popis
    symbol = (V),
    sort=U % seředit podle
}


\newglossaryentry{symbol:u1b-fazove-napeti-statoru}{
    type=symbolslist, % glossary
    name=$u_\text{1b}$, % jméno v seznamu
    description={velikost napětí statoru fáze B}, %popis
    symbol = (V),
    sort=U % seředit podle
}


\newglossaryentry{symbol:u1c-fazove-napeti-statoru}{
    type=symbolslist, % glossary
    name=$u_\text{1c}$, % jméno v seznamu
    description={velikost napětí statoru fáze C}, %popis
    symbol = (V),
    sort=U % seředit podle
}


\newglossaryentry{symbol:sw1}{
    type=symbolslist, % glossary
    name=$sw1$, % jméno v seznamu
    description={stav spínače č. 1 v trojfázovém invertoru}, %popis
    symbol = (1/0),
    sort=S % seředit podle
}
\newglossaryentry{symbol:sw2}{
    type=symbolslist, % glossary
    name=$sw2$, % jméno v seznamu
    description={stav spínače č. 2 v trojfázovém invertoru}, %popis
    symbol = (1/0),
    sort=S % seředit podle
}

\newglossaryentry{symbol:sw3}{
    type=symbolslist, % glossary
    name=$sw3$, % jméno v seznamu
    description={stav spínače č. 3 v trojfázovém invertoru}, %popis
    symbol = (1/0),
    sort=S % seředit podle
}

\newglossaryentry{symbol:sw4}{
    type=symbolslist, % glossary
    name=$sw4$, % jméno v seznamu
    description={stav spínače č. 4 v trojfázovém invertoru}, %popis
    symbol = (1/0),
    sort=S % seředit podle
}

\newglossaryentry{symbol:sw5}{
    type=symbolslist, % glossary
    name=$sw5$, % jméno v seznamu
    description={stav spínače č. 5 v trojfázovém invertoru}, %popis
    symbol = (1/0),
    sort=S % seředit podle
}

\newglossaryentry{symbol:sw6}{
    type=symbolslist, % glossary
    name=$sw6$, % jméno v seznamu
    description={stav spínače č. 6 v trojfázovém invertoru}, %popis
    symbol = (1/0),
    sort=S % seředit podle
}

\newglossaryentry{symbol:theta-transform-angle}{
    type=symbolslist, % glossary
    name=$\Theta$, % jméno v seznamu
    description={transformační úhel pro Parkovu transformaci}, %popis
    symbol = (rad),
    sort=T % seředit podle
}