; ModuleID = '/home/petr/Documents/xilinx-workspace/vitis-workspace/dp/kria-1-overlaping-app_kernels/Emulation-SW/build/vadd/vadd/vadd/solution/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: argmemonly noinline
define void @apatb_vadd_ir(i32* noalias nocapture nonnull %c, i32* noalias nocapture nonnull readonly %a, i32* noalias nocapture nonnull readonly %b, i32 %elements) local_unnamed_addr #0 {
entry:
  %c_copy = alloca i32, align 512
  %a_copy = alloca i32, align 512
  %b_copy = alloca i32, align 512
  call fastcc void @copy_in(i32* nonnull %c, i32* nonnull align 512 %c_copy, i32* nonnull %a, i32* nonnull align 512 %a_copy, i32* nonnull %b, i32* nonnull align 512 %b_copy)
  call void @apatb_vadd_hw(i32* %c_copy, i32* %a_copy, i32* %b_copy, i32 %elements)
  call void @copy_back(i32* %c, i32* %c_copy, i32* %a, i32* %a_copy, i32* %b, i32* %b_copy)
  ret void
}
