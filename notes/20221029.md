...
- zkontroloval jsem i podle návodu co někdo kontroloval [xilinx](https://support.xilinx.com/s/question/0D52E00006hpbh0SAA/usb-host-not-working-on-digilent-zybo?language=en_US), že je použito USB, zkoušám buildit a přidal jsem další package
