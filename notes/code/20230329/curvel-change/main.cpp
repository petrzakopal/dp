...
int main(int argc, char* argv[]) {
    ...
    */
    ...
    int masterInputLength = 41;
    int masterOutputLength = 20;
    int masterMotorInputLength = 39;
    int masterMotorOutputLength = 10;

    float masterInput[masterInputLength];
    float masterOutput[masterOutputLength];
    float masterMotorInput[masterMotorInputLength];
    float masterMotorOutput[masterOutputLength];
    ...
    /*------------------------------------------------------------*/
        ...
        * */
        ...
        // we got switches from kernel
            ...
            /***************************************************/
            // ASM
            krnl_calculateInvMot(masterMotorInput, masterMotorOutput);
