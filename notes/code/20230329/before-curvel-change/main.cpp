...
int main(int argc, char* argv[]) {
    ...
    */
    ...
    /* SETTING BUFFER AND POINTERS FOR CURVEL MODEL KERNEL */

   


    float masterInput[4096];
    float masterOutput[4096];

    /* SETTING BUFFER AND POINTERS FOR INVERTOR AND ASYNCHRONOUS MOTOR MODEL KERNEL */

  


    float masterMotorInput[4096];
    float masterMotorOutput[4096];
